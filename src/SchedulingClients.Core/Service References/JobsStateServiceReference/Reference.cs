...
namespace SchedulingClients.Core.JobsStateServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="JobsStateDto", Namespace="http://schemas.datacontract.org/2004/07/Scheduling.Services.Jobs.Dtos")]
    [System.SerializableAttribute()]
    public partial class JobsStateDto : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="JobsStateServiceReference.IJobsStateService", CallbackContract=typeof(SchedulingClients.Core.JobsStateServiceReference.IJobsStateServiceCallback))]
    public interface IJobsStateService {
        ...
        GAAPICommon.Core.Dtos.ServiceCallResultDto AbortAllJobs();
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<int[]>))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<GAAPICommon.Core.Dtos.SemVerDto>))]
        GAAPICommon.Core.Dtos.ServiceCallResultDto AbortAllJobsForAgent(int agentId);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<int[]>))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<GAAPICommon.Core.Dtos.SemVerDto>))]
        GAAPICommon.Core.Dtos.ServiceCallResultDto AbortJob(int jobId, string note);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<int[]>))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(GAAPICommon.Core.Dtos.ServiceCallResultDto<GAAPICommon.Core.Dtos.SemVerDto>))]
        GAAPICommon.Core.Dtos.ServiceCallResultDto AbortTask(int taskId);
        ...
        GAAPICommon.Core.Dtos.ServiceCallResultDto<int[]> GetActiveJobIdsForAgent(int agentId);
    }
    ...
    public interface IJobsStateServiceCallback {
        ...
        void OnCallback(SchedulingClients.Core.JobsStateServiceReference.JobsStateDto callbackObject);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IJobsStateServiceChannel : SchedulingClients.Core.JobsStateServiceReference.IJobsStateService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class JobsStateServiceClient : System.ServiceModel.DuplexClientBase<SchedulingClients.Core.JobsStateServiceReference.IJobsStateService>, SchedulingClients.Core.JobsStateServiceReference.IJobsStateService {
        ...
        public GAAPICommon.Core.Dtos.ServiceCallResultDto AbortAllJobsForAgent(int agentId) {
            return base.Channel.AbortAllJobsForAgent(agentId);
        }
        
        public GAAPICommon.Core.Dtos.ServiceCallResultDto AbortJob(int jobId, string note) {
            return base.Channel.AbortJob(jobId, note);
        }
        
        public GAAPICommon.Core.Dtos.ServiceCallResultDto AbortTask(int taskId) {
            return base.Channel.AbortTask(taskId);
        }
        
        public GAAPICommon.Core.Dtos.ServiceCallResultDto<int[]> GetActiveJobIdsForAgent(int agentId) {
